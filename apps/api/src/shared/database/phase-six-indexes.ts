...
import { CourseProgressSnapshotModel } from '../../modules/reporting/course-progress-snapshot.model.js';
import { AnalyticsEventModel } from '../../modules/reporting/analytics-event.model.js';
...
export const PHASE_SIX_MODELS: readonly Model<unknown>[] = [
  ...
  CourseProgressSnapshotModel as Model<unknown>,
  AnalyticsEventModel as Model<unknown>,
