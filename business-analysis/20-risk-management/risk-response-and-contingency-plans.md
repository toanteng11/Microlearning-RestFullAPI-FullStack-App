...
| R-003 Cloud readiness | Thực hiện ADR-010; verify Google Cloud/Atlas account, region, quota, DNS/TLS, secret, registry và monitoring trước milestone. | Chuyển demo về approved Local fallback chỉ khi scope nêu rõ; reschedule Cloud release; không dùng account cá nhân không kiểm soát. | DevOps + PO. | ADR, environment checklist, deployment/health record, cost/quota confirmation. |
