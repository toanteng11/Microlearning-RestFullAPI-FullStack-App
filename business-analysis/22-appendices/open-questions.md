...
| --- | --- | --- | --- | --- | --- | --- |
| APP-Q-001 | Cloud provider, region, account/service ownership, quota/cost và Staging Cloud target nào được chọn? | Product Owner + DevOps | High | Before Staging Cloud / REL-MVP-1 RC | ISS-001, TR-GAP-006, REL-DEP-006 | Open; chưa có provider decision/ADR. |
...
| APP-Q-008 | CI/CD provider, registry, protected branch/check, deploy permission và artifact retention policy nào được dùng? | DevOps + Technical Lead | High | Before Release Candidate | ISS-002, R-012, REL-DEP-005 | Open; implementation evidence chưa có. |
