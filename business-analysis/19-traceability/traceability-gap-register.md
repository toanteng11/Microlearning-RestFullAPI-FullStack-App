...
| TR-GAP-006 | Cloud deployment evidence | Provider architecture đã resolved tại ADR-010/DEC-015; Google Cloud/Atlas account, Artifact Registry image, Cloud Run revision, secret/monitoring, quota/cost và smoke/rollback evidence chưa có. | Medium/High operational | Phase 07 environment/infrastructure/runbook và remote deployment evidence. | DevOps + Product Owner | Provider decision resolved; implementation evidence pending | Before Staging Cloud |
