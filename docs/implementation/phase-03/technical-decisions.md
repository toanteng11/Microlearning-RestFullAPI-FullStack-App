...
Toàn bộ `P03-ADR-001..018` được Project Owner chấp thuận ngày `2026-07-19` sau khi review BA revision `1.41`, `DEC-016/017`, API, data, security, frontend, QA và DevOps plan theo các góc nhìn của đồ án cá nhân. Các quyết định trở thành code baseline sau khi planning PR merge vào `main`.
