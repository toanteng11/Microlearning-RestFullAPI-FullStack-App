...
| P08-RSK-006 | RBAC/privacy/cross-scope leak | H/H | Security/TL | negative API/E2E and redaction | `MITIGATED - Part 03 remote PASS; Part 04 automation local PASS, remote evidence pending` |
...
| P08-ISS-003 | UAT/system tests and sign-off not executed | H/H | QA/BA/PO | G2/G3 execution | `PARTIAL - Part 03 remote PASS; Part 04-05 exact-candidate evidence and UAT pending` |
