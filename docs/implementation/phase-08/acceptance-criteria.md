...
| P08-AC-002 | Exact commit/digest/revision/URL nhất quán từ Staging test đến promotion | manifest, deployment/stable record | DevOps | `PENDING` |
| P08-AC-003 | System Test chạy toàn bộ Must technical/integration/API/data/security scope | test report + raw artifact | QA | `PENDING` |
