...
- `scripts/invoke-phase-08-production-secret-bootstrap.ps1` adds a second owner-only path for exactly four Production secret containers and four runtime accessor bindings. It cannot create/read versions and rejects Cloud Run, monitoring, mutation/destruction or a missing identity-bootstrap prerequisite.
