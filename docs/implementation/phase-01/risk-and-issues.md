...
| P01-R05 | Secret lọt Git/image/log | Medium/High | Ignore, redaction, audit/review | Controlled; scan remote needed |
| P01-R06 | CI chậm hoặc bị bỏ qua | Medium/Medium | npm cache và required checks | Pending remote settings |
...
| P01-I06 | Repository chưa có GitHub remote | External repository chưa được cung cấp | Open action trước PR đầu tiên | Open |
...
- CI branch protection chưa thể cưỡng chế khi chưa có remote.
