...
| --- | --- | --- | --- | --- | --- |
| P02-T001 | Review BA FR-001..010/064/065/067/069, NFR và AC | P01 | Review record | 0.5 | Ready |
| P02-T002 | Phê duyệt token/cookie/session decision | T001 | Security baseline | 0.5 | Ready |
| P02-T003 | Phê duyệt password/rate/cooldown decision | T001 | Security baseline | 0.25 | Ready |
| P02-T004 | Review role/permission/status transition | T001 | RBAC matrix | 0.5 | Ready |
| P02-T005 | Review API schemas/errors/list query | T001 | API baseline | 0.5 | Ready |
| P02-T006 | Review collection/index/transaction | T001 | Data baseline | 0.5 | Ready |
| P02-T007 | Threat model auth/invitation/admin actions | T002..T006 | Threat-control record | 0.5 | Ready |
| P02-T008 | Chốt raw invitation link one-time UX | T002/T005 | BA/UI decision | 0.25 | Ready |
| P02-T009 | Chốt bootstrap Super Admin operation | T004/T006 | Bootstrap decision | 0.25 | Ready |

## 3. P02-E02 - Runtime And Data Foundation

| Task | Nội dung | Dependency | Output | Est. | Status |
| --- | --- | --- | --- | --- | --- |
| P02-T010 | Thêm auth/env schema và fail-fast tests | T002/T003 | Config contract | 0.75 | Ready |
| P02-T011 | Chuyển Local Mongo sang single-node replica set | T006 | Compose runtime | 0.75 | Ready |
| P02-T012 | Thêm replica-set init/readiness | T011 | Init + health | 0.5 | Backlog |
