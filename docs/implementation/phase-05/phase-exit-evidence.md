...
| --- | --- | --- |
| Gate A | Planning PR/review/CI/merge/readiness | Pending |
...
| --- | --- | --- | --- |
| Question media URL | Pending decision | Not evaluated | - |
| Assignment LINK/MARK_DONE | Pending decision | Not evaluated | - |
| Private comments | Pending decision | Not evaluated | - |
| Basic Gradebook | Pending decision | Not evaluated | - |
