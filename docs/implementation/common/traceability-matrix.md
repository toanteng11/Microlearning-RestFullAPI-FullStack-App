...
| P06   | Dashboard/reporting requirements, FR-016/018/027/049/050/055/059..064 và REP-001..020 | Student/Teacher/Admin dashboards, process score, Gradebook, ranking và reports | Detailed planning package tại `../phase-06/`; implementation chưa bắt đầu | `68` Must + `6` Conditional AC; Gate A/local baseline Pass | Approved; Ready to Code after planning merge |
