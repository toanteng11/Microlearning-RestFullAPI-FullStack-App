...
| P04   | Course/content requirements, FR-026..035 và learning slice FR-049/050/052/053/057 | Learning content, deadline, Lesson completion, To-do/dashboard v1 | Local release candidate trên `feature/phase-04-content-foundation`; PR/merge pending | `64/66` Must Pass local; `2` Conditional N/A; API/Web/Mongo/OpenAPI/E2E/performance gates pass | Ready for implementation PR |
