...
| P03   | Classroom processes, FR-011/012/020..025/064/065/067/069                          | Classroom, credentials, enrollment, roster và policy    | Planning approved; chờ planning PR merge, implementation chưa bắt đầu              | `45` AC đang `Not Run`; strategy/evidence template trong `../phase-03/`                            | Approved pending PR merge |
