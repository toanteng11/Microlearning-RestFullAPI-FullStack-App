...
| P03   | Classroom processes, FR-011/012/020..025/064/065/067/069                          | Classroom, credentials, enrollment, roster và policy    | Must scope hoàn tất local trên `feature/phase-03-data-foundation`; PR #5 là planning baseline | `44/45` AC Pass local; API/Web/Mongo/OpenAPI/E2E/Docker/clean-clone evidence trong `../phase-03/`; remote CI pending | Local exit candidate |
