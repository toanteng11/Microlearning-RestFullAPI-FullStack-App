...
| P05   | Assessment requirements, FR-036..048 và learning/reporting extensions              | Quiz, assignment, grading, deadline exception và activity v2 | Planning package tại `../phase-05/`; runtime implementation chưa bắt đầu         | `78` AC ở trạng thái Not Run; test/evidence model tại `../phase-05/`                               | Ready for Gate A review |
