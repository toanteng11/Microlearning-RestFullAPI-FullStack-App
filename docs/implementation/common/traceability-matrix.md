...
| P02   | Authentication, User Roles, FR-001..010/064/065/067/069, business rules liên quan | Identity, RBAC, user administration, Teacher invitation | PR-02A đang triển khai typed auth config, MongoDB `rs0`, primary readiness và transaction harness | Unit/local transaction evidence trong `../phase-02/evidence-register.md`; remote CI pending        | In progress |
