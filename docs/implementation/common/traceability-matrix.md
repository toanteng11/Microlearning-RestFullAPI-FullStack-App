...
| P06   | Dashboard/reporting requirements, FR-016/018/027/049/050/055/059..064 và REP-001..020 | Student/Teacher/Admin dashboards, process score, Gradebook, ranking, governance, bounded CSV, analytics foundation và trend | Part 01-16 local implementation; conditional commit `f1baf06`; quality/evidence branch | API `230`, Web `126`, integration `97`, OpenAPI `10`, E2E `34`, clean clone Pass | `LOCAL_RELEASE_CANDIDATE_REMOTE_PENDING` |
| P07   | FR-064..075, BRQ-024/025, DOP-AC-001..018 và ADR-010                              | Same-origin Cloud Run, Atlas Staging, Terraform, WIF, registry, secrets, CD, monitoring và recovery | 66-file detailed baseline tại `../phase-07/`; 18 execution parts; implementation chưa bắt đầu | 70-case catalog/execution matrix và `66` Must + `6` Conditional AC đã thiết kế; local regression Pass, Cloud evidence chưa có | `DRAFT_FOR_GATE_A_REVIEW` |
