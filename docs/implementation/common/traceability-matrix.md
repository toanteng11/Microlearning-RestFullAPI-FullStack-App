...
| P04   | Course/content requirements, FR-026..035 và learning slice FR-049/050/052/053/057 | Learning content, deadline, Lesson completion, To-do/dashboard v1 | Planning baseline tại `../phase-04/`; implementation chưa bắt đầu | `68` AC đã định nghĩa (`66` Must + `2` Conditional), toàn bộ đang `Not Run` | Ready for review |
