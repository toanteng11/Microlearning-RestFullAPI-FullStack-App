...
| P06   | Dashboard/reporting requirements, FR-016/018/027/049/050/055/059..064 và REP-001..020 | Student/Teacher/Admin dashboards, process score, Gradebook, ranking và reports | Part 01-12 local implementation; Gradebook commit `fe36dda`; Parent PR stack remote pending | Planning AC `8/8`; Gradebook stack API `215`, Web `115`, integration `90`, E2E `32` Local Pass | `IN_REVIEW_STACKED`; Part 13 blocked by P06-PR05 merge |
