...
- Deployment: Cloud-ready configuration; nhà cung cấp Cloud được chốt trước Phase 07.
...
| --- | --- | --- | --- | --- |
| 01 | Project Foundation | Repository, Web/API skeleton, MongoDB local, Swagger, Docker Compose và CI baseline | BA architecture baseline | Implemented locally; external CI verification pending |
| 02 | Authentication and Users | Student registration, login/session, RBAC, Admin user lists và Teacher invitation | Phase 01 | Planned |
| 03 | Classroom Management | Classroom CRUD, enrollment, class code, invite link và roster | Phase 02 | Planned |
| 04 | Learning Content | Course, module, lesson, resource, publish lifecycle và deadline | Phase 03 | Planned |
...
| Object storage provider | Trước media upload ở Phase 04/05 | DevOps/Backend Lead | Chỉ có thể hỗ trợ URL/resource cơ bản. |
| Cloud và CI/CD provider | Trước Phase 07 | Product Owner/DevOps | Không thể triển khai Staging Cloud chính thức. |
